...
Є Wi-Fi роутер чи ADSL модем чи будь який інший малопотужний пристрій до 5 Вт. Навіть Led ленти освітлення можна в список додати. Для тесту є декілька пристроїв: Роутери TP-Link, Kinetic, медіконвертори і т.д. з Живленням 12В. Середнє споживання ~250-400 mA. Задача забезпечити можливість автономної роботи (ну як при work from home і без інтернету) при відсутності вхідної напруги (мої оператори УкрТелеКом і X-My.Net функціонують при відсутності напруги в будинку).
